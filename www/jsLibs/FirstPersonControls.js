...
THREE.FirstPersonControls = function ( cam, domElement ) {
	...
	this.onKeyDown = function ( event ) {
		...
		switch ( event.keyCode ) {
			...
			case 70: this.freeze == true ? this.freeze = false : this.freeze = true; break; 
			case 38: /*up*/
	...
	this.update = function( delta ) {
		...
		if ( this.isForwardCanMove == false ){
			this.moveForward = false;
		}
		...
		if ( this.heightSpeed ) {
			...
			var y = THREE.Math.clamp( this.cam.position.y, this.heightMin, this.heightMax );
